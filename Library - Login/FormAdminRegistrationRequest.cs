...
{
    public partial class FormAdminRegistrationRequest : Form
    {
        int waitingReg;
        string AdminID;
        Connect2DB con = new Connect2DB();

        public FormAdminRegistrationRequest(string UserID)
        {
            InitializeComponent();
        ...
        public FormAdminRegistrationRequest(string username, string password)
        {
            InitializeComponent();
            DatabaseInfo.Visible = false;
